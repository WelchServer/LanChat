...
V1.0:
  ...
  It is worth it to not that the file transfer system is using IPAddress.Any which is a low security option. Future updates of LanChat will take security into consideration but it is currently a trusted peer-to-peer project not one to use on any public network.
